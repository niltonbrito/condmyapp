...
$(document).ready(function() {
    // Inicializa a máscara nos campos de CPF e CNPJ
    $('#cpf').mask('000.000.000-00', {reverse: true});
	$('#phone').mask('(00) 00000-0000', {reverse: true});
    
    // Reaplica a máscara nos inputs quando necessário
    ...
    // Quando a tabela for redesenhada, aplique a máscara novamente (se necessário)
    $('#dataTable').on('draw.dt', function() {
        $('#cpf').mask('000.000.000-00', {reverse: true});
    });

    // Exemplo de como aplicar máscaras após alterações
...
$(document).ready(function() {
     $('#dataTable').DataTable({
         ...
         "drawCallback": function(settings) {
             // Aplica as máscaras nas células de CPF e celular depois de renderizar a tabela
             $('#dataTable tbody tr').each(function() {
                 var phoneCell = $(this).find('td').eq(4);  // Índice da coluna de Celular
                 
                 var phone = phoneCell.text().replace(/\D/g, ""); // Remover tudo que não for número

                 phoneCell.text(mascaraPhone({value: phone})); // Aplica a máscara de celular
             });
         }
     });
 });
